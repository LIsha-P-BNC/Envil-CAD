...
DIALOG_UPDATE_NOTICE_BASE::DIALOG_UPDATE_NOTICE_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : DIALOG_SHIM( parent, id, title, pos, size, style )
{
	...
	m_messageLine1 = new wxStaticText( this, wxID_ANY, _("A new version of Anvil is available!"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_btnRemind->SetToolTip( _("Close this update notice. The update notice will be shown again when you relaunch Anvil.") );
