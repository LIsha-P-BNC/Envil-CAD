...
TOOL_INTERACTIVE* GERBVIEW_FRAME::getCurrentMenuTool()
{
    return m_toolManager->GetTool<GERBVIEW_SELECTION_TOOL>();
}


void GERBVIEW_FRAME::buildFileMenu( ACTION_MENU* fileMenu )
{
    GERBVIEW_SELECTION_TOOL* selTool = m_toolManager->GetTool<GERBVIEW_SELECTION_TOOL>();
    static ACTION_MENU* openRecentGbrMenu;
    static ACTION_MENU* openRecentDrlMenu;
