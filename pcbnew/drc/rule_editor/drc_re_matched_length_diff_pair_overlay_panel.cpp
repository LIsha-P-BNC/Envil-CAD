        ...
        m_unitsProvider( pcbIUScale, aUnits )
{
    ...
    m_withinDiffPairsCheckbox->Bind( wxEVT_CHECKBOX, notifyModified );
    ...
    m_withinDiffPairsCheckbox->Bind( wxEVT_CHECKBOX, notifySave );
...
bool DRC_RE_MATCHED_LENGTH_DIFF_PAIR_OVERLAY_PANEL::TransferDataToWindow()
{
    ...
    m_withinDiffPairsCheckbox->SetValue( m_data->GetWithinDiffPairs() );
...
bool DRC_RE_MATCHED_LENGTH_DIFF_PAIR_OVERLAY_PANEL::TransferDataFromWindow()
{
    ...
    m_data->SetWithinDiffPairs( m_withinDiffPairsCheckbox->GetValue() );
