...
#ifndef DRC_RE_ROUTING_WIDTH_OVERLAY_PANEL_H
#define DRC_RE_ROUTING_WIDTH_OVERLAY_PANEL_H
...
class DRC_RE_ROUTING_WIDTH_CONSTRAINT_DATA;
class UNIT_BINDER;


/**
 * Overlay panel for routing width constraints showing min/preferred/max width fields
 * positioned over a diagram.
 */
class DRC_RE_ROUTING_WIDTH_OVERLAY_PANEL : public DRC_RE_BITMAP_OVERLAY_PANEL
{
public:
    DRC_RE_ROUTING_WIDTH_OVERLAY_PANEL( wxWindow* aParent,
