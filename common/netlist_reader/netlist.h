 ...
 *
 * This is the base class that handles netlist data without PCB-specific
 * dependencies like FOOTPRINT. Derived classes in pcbnew can extend this
 * with footprint-specific functionality.
 */
class COMPONENT
{
public:
