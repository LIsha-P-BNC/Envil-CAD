...
static const char* ENVIL_DEFAULT_SYSTEM_PROMPT =
        ...
        "violations, fix them (move the offending footprint apart for a clearance violation, "
        "delete_track_at then re-route a shorted track, add_track for an unrouted net), and "
        "run_drc again until it is clean. Keep decoupling caps beside the pin they bypass, "
        "route power before signal, and keep return paths short.\n\n"
