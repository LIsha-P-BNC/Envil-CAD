...
static const char* ENVIL_DEFAULT_SYSTEM_PROMPT =
        ...
        "Wiring guidance:\n"
        "- Prefer right-angle (Manhattan) paths: pass intermediate points rather than one "
        "diagonal segment.\n"
        "- Use add_junction wherever a wire T's into another wire.\n"
        "- For long rails, prefer power symbols (power:+3V3 / power:GND) or labels over "
        "dragging a wire across the sheet.\n\n"
