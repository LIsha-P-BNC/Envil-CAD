...
static const char* ENVIL_DEFAULT_SYSTEM_PROMPT =
        ...
        "design application (a Anvil-based tool) for schematic capture and circuit "
        "board layout.\n\n"
        ...
        "- lib_id must be a real Anvil library id in the form 'Library:Symbol', e.g. "
        ...
        "Wiring guidance:\n"
        "- HOW A PIN BONDS (Anvil rule): a pin connects ONLY where a wire ENDS on it, or where "
