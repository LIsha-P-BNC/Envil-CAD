...
static const std::map<int, COLOR4D> s_defaultTheme =
        {
            ...
            { LAYER_JUNCTION,             CSS_COLOR( 16,  185, 129, 1 ) },
            { LAYER_GLOBLABEL,            CSS_COLOR( 94,  234, 212, 1 ) },
            { LAYER_HIERLABEL,            CSS_COLOR( 45,  212, 191, 1 ) },
            ...
            { LAYER_NOCONNECT,            CSS_COLOR( 94,  234, 212, 1 ) },
            { LAYER_NOTES,                CSS_COLOR( 130, 200, 180, 1 ) },
            ...
            { LAYER_REFERENCEPART,        CSS_COLOR( 94,  234, 212, 1 ) },
#ifdef __WXMAC__
            // Try to mimic the system highlight color on Mac
            { LAYER_SELECTION_SHADOWS,      COLOR4D( 0.06, 0.72, 0.5, 0.6 ) },
#else
            { LAYER_SELECTION_SHADOWS,      COLOR4D( 0.06, 0.72, 0.5, 0.8 ) },
#endif
            ...
            { LAYER_SHEETLABEL,             CSS_COLOR( 94,  234, 212, 1 ) },
...
static const std::map<int, COLOR4D> s_classicTheme =
        {
            // ---- NEMI Emerald Light (schematic) : Bone White #FEFEFE + emerald ink ----
            { LAYER_SCHEMATIC_ANCHOR,       CSS_COLOR( 16, 163, 126, 1 ) },
            { LAYER_SCHEMATIC_AUX_ITEMS,    COLOR4D( BLACK ) },
            { LAYER_SCHEMATIC_BACKGROUND,   CSS_COLOR( 254, 254, 254, 1 ) },
            { LAYER_HOVERED,                CSS_COLOR( 16, 163, 126, 1 ) },
            { LAYER_BRIGHTENED,             CSS_COLOR( 16, 163, 126, 1 ) },
            { LAYER_BUS,                    CSS_COLOR( 13, 148, 136, 1 ) },
            { LAYER_BUS_JUNCTION,           CSS_COLOR( 13, 148, 136, 1 ) },
            { LAYER_DEVICE_BACKGROUND,      CSS_COLOR( 236, 231, 221, 1 ) },
            { LAYER_DEVICE,                 CSS_COLOR( 10, 73, 56, 1 ) },
            ...
            { LAYER_FIELDS,                 CSS_COLOR( 138, 138, 133, 1 ) },
            { LAYER_SCHEMATIC_GRID,         CSS_COLOR( 210, 220, 217, 1 ) },
            { LAYER_SCHEMATIC_GRID_AXES,    CSS_COLOR( 16, 163, 126, 1 ) },
            { LAYER_HIDDEN,                 COLOR4D( LIGHTGRAY ) },
            { LAYER_JUNCTION,               CSS_COLOR( 16, 163, 126, 1 ) },
            { LAYER_GLOBLABEL,              CSS_COLOR( 10, 73, 56, 1 ) },
            { LAYER_HIERLABEL,              CSS_COLOR( 13, 148, 136, 1 ) },
            ...
            { LAYER_NOCONNECT,              CSS_COLOR( 16, 163, 126, 1 ) },
            { LAYER_NOTES,                  CSS_COLOR( 13, 148, 136, 1 ) },
            { LAYER_PRIVATE_NOTES,          CSS_COLOR( 45, 150, 130, 1 ) },
            { LAYER_NOTES_BACKGROUND,       COLOR4D( UNSPECIFIED_COLOR ) },
            { LAYER_PIN,                    CSS_COLOR( 16, 163, 126, 1 ) },
            { LAYER_PINNAM,                 CSS_COLOR( 13, 148, 136, 1 ) },
            { LAYER_PINNUM,                 CSS_COLOR( 7, 7, 7, 1 ) },
            { LAYER_REFERENCEPART,          CSS_COLOR( 10, 73, 56, 1 ) },
#ifdef __WXMAC__
...
#endif
            { LAYER_SHEET,                  CSS_COLOR( 10, 73, 56, 1 ) },
            { LAYER_SHEET_BACKGROUND,       COLOR4D( WHITE ).WithAlpha( 0.0 ) },
            { LAYER_SHEETFILENAME,          CSS_COLOR( 13, 148, 136, 1 ) },
            { LAYER_SHEETFIELDS,            CSS_COLOR( 138, 138, 133, 1 ) },
            { LAYER_SHEETLABEL,             CSS_COLOR( 10, 73, 56, 1 ) },
            { LAYER_SHEETNAME,              CSS_COLOR( 10, 73, 56, 1 ) },
            { LAYER_VALUEPART,              CSS_COLOR( 100, 116, 110, 1 ) },
            { LAYER_WIRE,                   CSS_COLOR( 10, 73, 56, 1 ) },
            { LAYER_SCHEMATIC_DRAWINGSHEET, CSS_COLOR( 13, 148, 136, 1 ) },
