...
KICAD_SETTINGS::KICAD_SETTINGS() :
        ...
        m_ShowHistoryPanel( false ), m_ShowAiChat( true ), m_AiChatPanelWidth( 380 )
{
    ...
    m_params.emplace_back( new PARAM<bool>( "aui.show_ai_chat", &m_ShowAiChat, true ) );
    m_params.emplace_back( new PARAM<int>( "aui.ai_chat_panel_width", &m_AiChatPanelWidth, 380 ) );
