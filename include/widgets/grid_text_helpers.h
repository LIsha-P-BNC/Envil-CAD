...
class KICOMMON_API GRID_CELL_NULLABLE_INTERFACE
{
public:
...
class KICOMMON_API GRID_CELL_MARK_AS_NULLABLE : public wxGridCellTextEditor, public GRID_CELL_NULLABLE_INTERFACE
{
public:
