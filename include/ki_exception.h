 ...
 * by a file generated by a newer version of Anvil than this. This can be used to generate
 * more informative error messages.
 */
struct KICOMMON_API FUTURE_FORMAT_ERROR : public PARSE_ERROR
{
    wxString requiredVersion;   ///< Date of Anvil file format required to open file
    wxString requiredGenerator; ///< Version of Anvil required to open file
